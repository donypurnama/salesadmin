...
<html>
	...
	function delcommgroup(commgroupcode,divisionid) {
		...
		location.href='viewoverridingds.php?del=1&commgroupcode=' + commgroupcode + '&divisionid=' + divisionid;
		}
	}
</script>
</head>
...
<table border='0' cellspacing=1 cellpadding=1 width='15%' align='center' >
<tr><td ><div class="header icon-48-sections">Overriding DS</td></tr>
<tr>
	<td>
...
if ($search == 1 && $divisionid <> '') {
	...
	echo "<td colspan=3 align='center' width=><b>".$row['overdsgroupcode']."</b></td>";
	echo "</tr>";
	echo "<tr class=small>";
	...
	if($row['overdsgroupcode'] == $resdef['overdsgroupcode']) {
		echo "<img src='../templates/images/b_primary_active.png'>";
	} else {
		echo "<a href='defaultoverridingds.php?divisionid=".$divisionid."&op=delete&commgroupcode=".$row['overdsgroupcode']."'>
	...
	if ($_SESSION['groups'] == 'root' ) { 	  
		echo "<a href='viewoverridingds.php?overdsgroupcode=".$row['overdsgroupcode']."' class=smalllink>
		<img src='../templates/images/b_edit.png'>&nbsp;</a>
		<a href='javascript:delcommgroup(\"".$row['overdsgroupcode']."\",\"".$divisionid."\")' class=smalllink><img src='../templates/images/b_drop.png' name='drop'></a>";
	...
	if ($_SESSION['groups'] == 'root' ) { 	
	echo "<center><a href='editoverridingds.php?act=4&divisionid=".$divisionid."' class=smalllink>Add New Commission Type</a></center>";
	} 
