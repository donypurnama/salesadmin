...
if ($section == "sales"){
	...
	echo "window.opener.document.getElementById('commtype').innerHTML='".$commstr."';";
	 ...
	 echo "window.opener.document.forms[0].commdsgroupcode.value='".$rdocomm."';";
	echo "window.opener.document.getElementById('commdstype').innerHTML='".$commstr."';";
}elseif($section == "tr"){
	echo "window.opener.document.forms[0].commtrgroupcode.value='".$rdocomm."';";
	echo "window.opener.document.getElementById('commtrtype').innerHTML='".$commstr."';";
}
	echo "window.close();";
	echo "</script>";
}
...
<script language=javascript>
	function choosediv() {
		...
		location.href='commission.php?section=<?php echo $section; ?>&divisionid='+division+'&search=1';
	}
</script>
...
<body>
<form name=frmadd method=post action="commission.php?choose=1&section=<?php echo $section; ?>">
...
if ($search == 1 && $divisionid <> '' && $divisionid <> '0') {
	...
	/* ALL COMMISSION SHOW */		
		...
		echo "<br><div align=center><a href='commission.php?section=".$section."&divisionid=".$seldivision."&search=1&othercomm=all'>Other Commission Type
