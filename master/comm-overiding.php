...
<html>
	...
	function delcommgroup(commgroupcode,divisionid) {
		...
		location.href='viewoverriding.php?del=1&commgroupcode=' + commgroupcode + '&divisionid=' + divisionid;
		}
	}
</script>
</head>
...
<tr>
  <td ><div class="header icon-48-sections"> Overriding TR</td>
</tr>
<tr>
	<td>
...
if ($search == 1 && $divisionid <> '') {
	...
	if($row['overgroupcode'] == $resdef['overgroupcode']) {
		echo "<img src='../templates/images/b_primary_active.png'>";
	} else {
		echo "<a href='defaultoverriding.php?divisionid=".$divisionid."&op=delete&commgroupcode=".$row['overgroupcode']."'>
	...
	if ($_SESSION['groups'] == 'root' ) { 	  
		echo "<a href='viewoverriding.php?overgroupcode=".$row['overgroupcode']."' class=smalllink>
		<img src='../templates/images/b_edit.png'>&nbsp;</a>
		<a href='javascript:delcommgroup(\"".$row['overgroupcode']."\",\"".$divisionid."\")' class=smalllink><img src='../templates/images/b_drop.png' name='drop'></a>";
	...
	if ($_SESSION['groups'] == 'root' ) { 	
	echo "<center><a href='editoverriding.php?act=4&divisionid=".$divisionid."' class=smalllink>Add New Commission Type</a></center>";
	} 
