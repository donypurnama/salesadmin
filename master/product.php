...
<body>
	...
	<form name='frmprod' method='post' action="product.php?divisionid=<? echo $divisionid; ?>&search=1">
		...
		<table border="0" cellspacing="0" cellpadding="7" align="center" width="60%" bgcolor="#e5ebf9">
			<tr bgcolor='white'>
				...
				<tr>
					...
					{ ?>
						<a href='insertproduct.php?act=1&divisionid=<?php echo $divisionid; ?>' class='small'>Add New Product</a> | 
					<? 
					} ?>
						Division: 
